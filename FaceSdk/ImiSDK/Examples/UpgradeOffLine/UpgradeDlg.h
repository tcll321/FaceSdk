...
protected:
	...
	afx_msg void OnBnGetFwPath();
	afx_msg void OnBnGetColorPath();
	afx_msg void OnBnGetBridgeFwPath();
	afx_msg void OnBnOffLineUpgrade();
...
private:
	...
	ImiUpgradeRomPath       m_upGradeRomPath;
public:
	CStatic m_StaticMsg;
