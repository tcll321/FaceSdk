 ...
 **/
IMINECT_EXP int32_t IMINECT_API imiInitialize();
 ...
 * @return 0: success, < 0 : error
 **/
IMINECT_EXP int32_t IMINECT_API imiInitialize2(ImiDriverInfo* mDriverInfo);
 ...
 * @return 0:success, < 0 :error
 **/
IMINECT_EXP int32_t IMINECT_API imiOpenDevice2(uint32_t vid, uint32_t pid, uint32_t fd, const char* pUsbFsPath, ImiDeviceHandle* pDevice, int32_t reserve);
