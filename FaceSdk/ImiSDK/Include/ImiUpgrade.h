...
IMINECT_EXP int32_t IMINECT_API imiDeviceRequestUpgrade(ImiDeviceHandle pDevice);

IMINECT_EXP int32_t IMINECT_API imiDeviceStartUpgrade(ImiDeviceHandle pDevice, const ImiUpgradeCallbacks* pCallbacks);

IMINECT_EXP int32_t IMINECT_API imiDeviceStartUpgradeOffLine(ImiDeviceHandle pDevice, const ImiUpgradeCallbacks* pCallbacks, const ImiUpgradeRomPath* pUpgradeRomPath);
